...
router.put('/:id', async (req, res) => {
  try {
    ...
    if (custom_interval_days !== undefined) updateData.custom_interval_days = custom_interval_days;
    if (custom_reminder_days_before !== undefined) updateData.custom_reminder_days_before = custom_reminder_days_before;
