...
router.get('/oauth/callback', async (req, res) => {
  ...
  try {
    ...
    await settingsService.updateSetting('calendar_connected', 'true');
...
router.post('/disconnect', async (req, res) => {
  try {
    await settingsService.updateSetting('google_calendar_access_token', '');
    await settingsService.updateSetting('google_calendar_refresh_token', '');
    await settingsService.updateSetting('calendar_connected', 'false');
...
router.get('/status', async (req, res) => {
  try {
    const connected = await settingsService.getSetting('calendar_connected');
    const hasAccessToken = await settingsService.getSetting('google_calendar_access_token');
