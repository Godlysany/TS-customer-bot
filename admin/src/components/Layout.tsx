...
import { LayoutDashboard, MessageSquare, Settings, BarChart3, Mail, Calendar, Users, LogOut, Shield, User, FileText, Briefcase, Percent, CheckSquare, UserCog } from 'lucide-react';
