...
class MarketingService {
      ...
      `);
        ...
        if (filters.sentimentScore) {
            filtered = filtered.filter(contact => {
                ...
                if (filters.sentimentScore.min && score < filters.sentimentScore.min)
                    return false;
                if (filters.sentimentScore.max && score > filters.sentimentScore.max)
                    return false;
                return true;
            });
        }
    ...
    async createCampaign(name, messageTemplate, filterCriteria, scheduledAt, createdBy) {
