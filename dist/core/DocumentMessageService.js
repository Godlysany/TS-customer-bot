...
exports.DocumentMessageService = void 0;
...
class DocumentMessageService {
     ...
     */
    async detectDocumentTriggers(message) {
        ...
        for (const service of services) {
            ...
            for (const keyword of keywords) {
                ...
                if (normalizedKeyword.includes(' ')) {
                    ...
                    const found = Array.from(messageWords).some(word => word === normalizedKeyword || // Exact match
     ...
     */
    async personalizeDocumentMessage(template, contact, conversationId, serviceName) {
        // Basic placeholder replacement helper
        const applyPlaceholders = (msg) => {
            return msg
...
"${baseTemplate}"`;
     ...
     */
    async recordDocumentSent(contactId, conversationId, serviceId, documentUrl) {
     ...
     */
    async wasDocumentAlreadySent(contactId, serviceId) {
...
exports.DocumentMessageService = DocumentMessageService;
exports.default = new DocumentMessageService();
